...
<body>
	...
	<center>
		<s:form action="editProjectInfo">
			<s:textfield name="id" label="项目id：" visible="false" />
			...
			<s:textfield name="budgetApplyTime" label="预算申报时间：" id="applyTime">
				<s:param name="value">
					<s:date name="budgetApplyTime" format="yyyy-MM-dd" />
				</s:param>
			</s:textfield>
			<s:textfield name="budgetApprovalTime" label="预算批准时间："
				id="approveTime">
				<s:param name="value">
					<s:date name="budgetApprovalTime" format="yyyy-MM-dd" />
				</s:param>
			</s:textfield>
			...
			<s:submit value="提交" cssStyle="float:left;" />
